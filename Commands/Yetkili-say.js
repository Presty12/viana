...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  ...
  if(!message.member.roles.cache.has(ayar.sahipRolu)) return message.channel.send(embed.setDescription(`Bu komutunu kullanabilmek için herhangi bir yetkiye sahip değilsin.`)).then(x => x.delete({timeout: 5000}));
