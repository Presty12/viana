...
module.exports = async (member) => {
  ...
  .setDescription(`
  **${client.emoji("gif1")} Viana'ya hoş geldin ${member}, seninle toplam \`${member.guild.memberCount}\` kişiyiz!**
  **${client.emoji("gif2")} Yan taraftaki ses kanallarına girerek kaydını yaptırabilirsin.**
  **${client.emoji("gif5")} Seninle <@&rolid> || <@&rolid> ilgilenecektir.**
  **${client.emoji("gif3")} Hesabının açılış tarihi: ${member.client.tarihHesapla(member.user.createdAt)}**
  **${client.emoji("gif4")} Hesabınız ${guvenilirlik ? "kayıt olmaya uygun değildir!" : "kayıt olmaya uygundur."}**
  `);
